...
const NewCars = () => {
  ...
  const fetchNewCars = async () => {
    try {
      ...
      // Build API parameters for new cars endpoint
      const params = {
      ...
      // Use direct fetch since we need the new-cars endpoint
      const queryString = new URLSearchParams(params).toString()
      const response = await fetch(`http://localhost:5000/api/cars/new-cars${queryString ? `?${queryString}` : ''}`, {
        headers: {
      ...
      setError(err.message || 'Failed to fetch new cars')
      console.error('Fetch new cars error:', err)
    } finally {
      setLoading(false)
    }
  }
    ...
    return (
      ...
      >
        ...
        >
          ...
          />
          <p className="text-gray-600 text-lg">Loading new cars...</p>
        </motion.div>
      </motion.div>
    )
  }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <Title
            ...
            subtitle="Discover Brand New Vehicles with Full Warranty Coverage"
          />
        </motion.div>
            ...
            >
              <div className="relative">
                ...
                <motion.input
                  ...
                  placeholder="Search new cars by brand, model, or features (e.g., SUV, GPS, Bluetooth)"
          ...
          >
            ...
            >
              ...
              >
                ...
                {sortedCars.length === 1 ? ' New Car' : ' New Cars'}
                {searchQuery && (
                  <motion.span
        ...
        {sortedCars.length > 0 ? (
          ...
          >
            ...
            >
              {searchQuery 
                ? `We couldn't find any new cars matching "${searchQuery}". Try adjusting your search terms or browse different categories.`
                : "We couldn't find any new cars at the moment. Please check back later."
              }
            </motion.p>
            {searchQuery && (
              <motion.button
        ...
        {sortedCars.length > 0 && (
          ...
          >
            <motion.button
              ...
              whileTap="tap"
            >
              <span className="relative z-10">Load More New Cars</span>
              <motion.svg
